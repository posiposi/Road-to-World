...
const inputMessage = <HTMLInputElement>document.querySelector('#input-message');
...
const addMessageList = async (addMessage: string) => {
  ...
  const sendDateTime: string = DateTimeObject.toLocaleString('ja-JP', {
    month: '2-digit',
    day: '2-digit',
    hour: 'numeric',
    minute: 'numeric',
...
const sendMessage = (): void => {
  axios
    .post(
      '/message/' + loginUserId + '/' + anotherUserId + '/' + bikeId + '/post',
