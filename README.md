...
* 2021/1/20〜現在：Dockerでの開発 Mysql 5.7 PHP 7.3.29 Laravel 6.20.34 nginx
※vscodeを使用したかったためMAMPへと移行しましたが、StripeのエラーがPHP7.4の環境で発生しました。
 そのため、Dockerの勉強にも良い機会と考えて環境構築を再度行いました。
 苦戦して2日も掛かってしまいましたが、インフラの勉強の大事さに気付くきっかけにもなって良かったです。
 これからはDockerのコマンドや根本的な考え方を学習していこうと考えています。
